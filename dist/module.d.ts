...
import { FetchOptions } from 'graphql-request';
...
type ModuleOptions = Partial<GqlConfig>;

declare const _default: _nuxt_schema.NuxtModule<GqlConfig<GqlClient<string>>, GqlConfig<GqlClient<string>>, false>;
...
export { type GqlError, type ModuleOptions, _default as default };
